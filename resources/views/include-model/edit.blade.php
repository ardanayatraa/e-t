{{-- resources/views/include-model/edit.blade.php --}}
<x-app-layout>
    <div>
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4">
                <h2 class="text-lg font-semibold border py-4 pl-6 pr-8 text-green-800 flex items-center gap-2">
                    Edit Include: {{ $includeModel->pemesanan_id }}
                </h2>
            </div>
            {{-- Form Card --}}
            <div class="bg-white border dark:bg-gray-800 sm:rounded-lg p-6">
                <form action="{{ route('include.update', $includeModel) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input id="bensin" name="bensin" type="text"
                                value="{{ old('bensin', $includeModel->bensin) }}" placeholder="Misal: Rp100.000"
                        ...
                        <div>
                            ...
                            <input id="parkir" name="parkir" type="text"
                                value="{{ old('parkir', $includeModel->parkir) }}" placeholder="Misal: Rp50.000"
                                class="block w-full border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200
                                       focus:ring-2 focus:ring-green-500 focus:border-green-500 rounded-lg p-2 transition" />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="supir" name="supir" type="text"
                                value="{{ old('supir', $includeModel->supir) }}" placeholder="Misal: Rp200.000"
                                class="block w-full border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200
                                       focus:ring-2 focus:ring-green-500 focus:border-green-500 rounded-lg p-2 transition" />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="makan_siang" name="makan_siang" type="text"
                                value="{{ old('makan_siang', $includeModel->makan_siang) }}"
                        ...
                        <div>
                            ...
                            <input id="makan_malam" name="makan_malam" type="text"
                                value="{{ old('makan_malam', $includeModel->makan_malam) }}"
                                placeholder="Misal: Rp75.000"
                                class="block w-full border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200
                                       focus:ring-2 focus:ring-green-500 focus:border-green-500 rounded-lg p-2 transition" />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="tiket_masuk" name="tiket_masuk" type="text"
                                value="{{ old('tiket_masuk', $includeModel->tiket_masuk) }}"
                    ...
                    <div class="flex items-center">
                        <input id="status_ketersediaan" name="status_ketersediaan" type="checkbox"
                            ...
                            {{ old('status_ketersediaan', $includeModel->status_ketersediaan) ? 'checked' : '' }} />
